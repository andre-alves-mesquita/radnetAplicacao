...
class LoginForm extends TPage
{
    ...
    function __construct($param)
    {
        ...
        $btn->style = 'height: 40px;width: 90%;display: block;margin: auto;font-size:17px;margin-bottom:10px;';
        $btn->layout = ['col-sm-5 display-flex'];


        $btn2 = $this->form->addAction('Voltar', new TAction(array($this, 'voltar')), '');
        $btn2->class = 'btn btn-primary';
        $btn2->style = 'height: 40px;width: 90%;display: block;margin: auto;font-size:17px;';
        $btn2->layout = ['col-sm-5 display-flex'];
